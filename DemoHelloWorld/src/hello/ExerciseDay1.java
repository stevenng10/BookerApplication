...
public class ExerciseDay1 {
	...
	public static void main(String[] args) {
		...
		while(user_input.length() > 1) {
			...
			user_input = String.valueOf(sum);
		}	
		
		if(sum == 1) {
			System.out.println("The number you entered is a magic number.");
		} else {
			System.out.println("The number you entered is NOT a magic number.");
		}
