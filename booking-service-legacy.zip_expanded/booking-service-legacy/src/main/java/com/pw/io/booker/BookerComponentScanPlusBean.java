...
@Configuration
@ComponentScan({ "com.pw.io.booker.repository.list", "com.pw.io.booker.config" })
public class BookerComponentScanPlusBean {

	public static void main(String[] args) {
		ApplicationContext context = new AnnotationConfigApplicationContext(BookerComponentScanPlusBean.class);
